...
RSpec.describe IdentitiesController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested identity as @identity" do
      identity = Identity.create! valid_attributes
      get :show, params: {id: identity.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested identity as @identity" do
      identity = Identity.create! valid_attributes
      get :edit, params: {id: identity.to_param}, session: valid_session
      expect(assigns(:identity)).to eq(identity)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Identity" do
        expect {
          post :create, params: {identity: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved identity as @identity" do
        post :create, params: {identity: invalid_attributes}, session: valid_session
        expect(assigns(:identity)).to be_a_new(Identity)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested identity" do
        identity = Identity.create! valid_attributes
        put :update, params: {id: identity.to_param, identity: new_attributes}, session: valid_session
        identity.reload
      ...
      it "assigns the requested identity as @identity" do
        identity = Identity.create! valid_attributes
        put :update, params: {id: identity.to_param, identity: valid_attributes}, session: valid_session
        expect(assigns(:identity)).to eq(identity)
      end
    ...
    context "with invalid params" do
      it "assigns the identity as @identity" do
        identity = Identity.create! valid_attributes
        put :update, params: {id: identity.to_param, identity: invalid_attributes}, session: valid_session
        expect(assigns(:identity)).to eq(identity)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested identity" do
      identity = Identity.create! valid_attributes
      expect {
        delete :destroy, params: {id: identity.to_param}, session: valid_session
      }.to change(Identity, :count).by(-1)
    end
