...
RSpec.describe DivesController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all dives as @dives" do
      dive = Dive.create! valid_attributes
      get :index, params: {}, session: valid_session
      expect(assigns(:dives)).to eq([dive])
    end
  end

  describe "GET #show" do
    it "assigns the requested dive as @dive" do
      dive = Dive.create! valid_attributes
      get :show, params: {id: dive.to_param}, session: valid_session
      expect(assigns(:dive)).to eq(dive)
    end
  end

  describe "GET #new" do
    it "assigns a new dive as @dive" do
      get :new, params: {}, session: valid_session
      expect(assigns(:dive)).to be_a_new(Dive)
    end
  end
  ...
  describe "GET #edit" do
    it "assigns the requested dive as @dive" do
      dive = Dive.create! valid_attributes
      get :edit, params: {id: dive.to_param}, session: valid_session
      expect(assigns(:dive)).to eq(dive)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created dive as @dive" do
        post :create, params: {dive: valid_attributes}, session: valid_session
        expect(assigns(:dive)).to be_a(Dive)
        expect(assigns(:dive)).to be_persisted
      end

      it "redirects to the created dive" do
        post :create, params: {dive: valid_attributes}, session: valid_session
        expect(response).to redirect_to(Dive.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved dive as @dive" do
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "redirects to the dive" do
        dive = Dive.create! valid_attributes
        put :update, params: {id: dive.to_param, dive: valid_attributes}, session: valid_session
        expect(response).to redirect_to(dive)
      end
    end

    context "with invalid params" do
      it "assigns the dive as @dive" do
        dive = Dive.create! valid_attributes
  ...
  describe "DELETE #destroy" do
    ...
    it "redirects to the dives list" do
      dive = Dive.create! valid_attributes
      delete :destroy, params: {id: dive.to_param}, session: valid_session
      expect(response).to redirect_to(dives_url)
    end
  end
